...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const adminNavigation = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-2.442l-2.5 2.5m0 0l-2.5 2.5m2.5-2.5h-7.5" />
        </svg>
      )
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className={`fixed inset-y-0 left-0 flex flex-col w-64 bg-white shadow-lg transform ${
      ...
      } lg:translate-x-0 transition-transform duration-300 ease-in-out lg:static lg:inset-0 z-40`}>
        ...
        <div className="flex items-center flex-shrink-0 px-4 py-4 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <h1 className="text-lg font-semibold text-gray-900">FaceAttend</h1>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="hidden sm:flex items-center space-x-2">
                <div className={`w-2 h-2 rounded-full ${isOnline ? 'bg-success-500' : 'bg-danger-500'}`}></div>
              ...
              {hasOfflineData && (
                <div className="hidden sm:flex items-center space-x-2 text-warning-600">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                  </svg>
                  <span className="text-sm">Unsynced</span>
                </div>
              )}
