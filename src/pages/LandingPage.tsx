  ...
  const features = [
    {
      ...
      description:
        "Advanced facial recognition technology with 99.9% accuracy for secure attendance tracking.",
    },
    {
      icon: <FaClock className="text-4xl text-green-600" />,
      title: "Real-time Tracking",
      description:
        "Instant attendance marking with live dashboard updates and notifications.",
    },
    {
      icon: <FaShieldAlt className="text-4xl text-purple-600" />,
      title: "Secure & Private",
      description:
        "End-to-end encryption ensures your biometric data remains completely secure.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Support for schools, offices, hotels, hospitals, and any organization type.",
    },
    {
      icon: <FaUserCheck className="text-4xl text-indigo-600" />,
      title: "Easy Management",
      description:
        "Simple user management with role-based access and approval workflows.",
    },
  ];
  ...
  const processSteps = [
    {
      ...
      title: "Face Capture",
      description:
        "High-quality camera captures facial features with advanced lighting compensation",
      image:
        "https://www.softwebsolutions.com/wp-content/uploads/2019/03/Facial-Recognition-application.jpg", // Digital identity scanning
      color: "blue",
      icon: <FaCamera className="text-4xl text-blue-600" />,
    },
    {
      ...
      title: "AI Analysis",
      description:
        "Advanced algorithms analyze biometric patterns and generate secure digital templates",
      image:
        "https://news.mit.edu/sites/default/files/styles/news_article__image_gallery/public/images/202203/face-600x900.png?itok=4wm2x8C2", // AI analysis interface
      color: "purple",
    ...
    },
    {
      ...
      title: "Instant Match",
      description:
        "Lightning-fast comparison provides instant verification with 99.9% accuracy",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkph7cQzrwT5R59ibMiX4KCccCWJRa1Gabfg&s", // Technology verification
      color: "green",
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-20 pb-12 md:pt-24 md:pb-20 bg-gradient-to-br from-blue-50 via-white to-purple-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-6 md:gap-10 lg:gap-14 items-center">
            <div className="space-y-5 md:space-y-7 lg:col-span-2">
              <div className="space-y-3 md:space-y-4">
                ...
                <p className="text-base md:text-lg text-gray-600 leading-relaxed">
                  Transform your organization's attendance tracking with
                  cutting-edge AI face recognition technology. Secure, accurate,
                  and effortless for schools, offices, hotels, and more.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 relative z-20">
                <Link
                  to="/register"
                  className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-5 sm:px-7 py-2.5 sm:py-3.5 rounded-full font-semibold flex items-center justify-center hover:shadow-xl transform hover:scale-105 transition-all duration-200 whitespace-nowrap text-sm sm:text-base"
                >
                ...
                <button
                  ...
                  className="border-2 border-blue-600 text-blue-600 px-5 sm:px-7 py-2.5 sm:py-3.5 rounded-full font-semibold flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all duration-200 whitespace-nowrap shadow-lg bg-white text-sm sm:text-base"
                >
      ...
      <section className="py-10 md:py-16 bg-gradient-to-br from-gray-50 via-white to-blue-50 relative overflow-hidden">
        {/* Background Elements */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-14">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-3">
              How Our <span className="text-blue-600">Face Recognition</span>{" "}
              Works
            </h2>
            <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
              Advanced AI technology makes attendance tracking effortless and
              secure
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-7 mb-10 md:mb-14">
            {processSteps.map((process, index) => (
              ...
              >
                <div
                  className={`w-14 h-14 md:w-18 md:h-18 rounded-full flex items-center justify-center mx-auto mb-3 transition-all duration-300 shadow-lg group-hover:shadow-xl ${
                    process.color === "blue"
          ...
          <div className="max-w-5xl mx-auto bg-white rounded-2xl md:rounded-3xl p-5 md:p-7 shadow-xl relative overflow-hidden group">
            <div className="relative h-44 md:h-72 overflow-hidden rounded-xl md:rounded-2xl">
              <img
              ...
              <div className="absolute bottom-3 left-3 md:bottom-5 md:left-5">
                <div className="bg-white/90 backdrop-blur-sm px-2 md:px-3 py-1.5 rounded-full shadow-lg">
                  <div className="flex items-center space-x-2 md:space-x-3">
                    <div
                      className={`p-1.5 rounded-full ${
                        processSteps[currentProcessStep].color === "blue"
                          ? "bg-blue-100"
                          : processSteps[currentProcessStep].color === "purple"
                          ? "bg-purple-100"
                          : "bg-green-100"
                      }`}
                    >
                    ...
                    <div>
                      <h4 className="text-xs md:text-sm font-semibold text-gray-900">
                        Step {processSteps[currentProcessStep].step}:{" "}
              ...
              {/* Progress Indicators */}
              <div className="absolute top-3 right-3 md:top-5 md:right-5 flex space-x-1 md:space-x-2">
            ...
            <div className="absolute top-3 left-3 md:top-5 md:left-5">
              <div className="bg-green-500 text-white px-2 md:px-3 py-1 rounded-full text-xs font-medium flex items-center animate-pulse">
      ...
      <section
        id="features"
        className="py-10 md:py-16 bg-gradient-to-br from-gray-50 via-white to-blue-50 relative overflow-hidden"
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-14">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-4">
              Everything you need to streamline attendance management across
              your organization
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-7">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-gray-900 group-hover:text-blue-600 transition-colors duration-300">
                  {feature.title}
                </h3>
      ...
      <section
        id="pricing"
        className="py-10 md:py-16 bg-gradient-to-br from-gray-50 to-blue-50"
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-14">
            ...
            {pricingPlans.map((plan, index) => (
              <div
                ...
                className={`bg-white rounded-3xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-200 ${
                  plan.popular
                    ? "ring-2 md:ring-4 ring-blue-500 transform md:scale-105"
                    : ""
                }`}
              >
                {plan.popular && (
                ...
                >
                  <div className="flex items-center mb-3 md:mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <FaStar
                        key={i}
                        className="text-yellow-400 text-base md:text-lg group-hover:text-yellow-500 transition-colors duration-300"
                        style={{
                  ...
                  <p className="text-gray-700 mb-4 md:mb-6 leading-relaxed group-hover:text-gray-800 transition-colors duration-300 text-sm md:text-base">
                    "{testimonial.text}"
                  </p>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs md:text-sm text-blue-600 font-medium group-hover:text-blue-700 transition-colors duration-300">
                        {testimonial.company}
                      </p>
                    </div>
                  </div>
      ...
      <footer className="bg-gradient-to-br from-slate-800 via-slate-900 to-blue-900 text-white relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full z-10">
          ...
          >
            <path
              d="M0,100 Q300,20 600,50 T1200,30 L1200,0 L0,0 Z"
              fill="white"
            />
          </svg>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-16 md:pt-20 pb-8 md:pb-12 overflow-hidden relative z-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-10 min-w-0">
            {/* Company Info */}
            <div className="sm:col-span-2 lg:col-span-2 min-w-0 relative z-30 pt-10">
              <div className="flex items-center space-x-3 mb-6 min-w-0 overflow-hidden">
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-3 md:p-4 rounded-xl flex-shrink-0 z-10 shadow-lg">
                  <FaCamera className="text-white text-lg md:text-sm" />
                </div>
                <span className="text-lg md:text-xl lg:text-2xl font-bold truncate text-blue-400 drop-shadow-sm">
                  FaceTrack
                </span>
              </div>

              <p className="text-gray-300 mb-6 leading-relaxed text-sm md:text-base max-w-md lg:max-w-lg">
                Leading the future of attendance management with AI-powered face
                recognition technology. Trusted by thousands of organizations
                worldwide for secure, accurate, and effortless attendance
                tracking.
              </p>
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                <a
                  href="#"
                  className="bg-gradient-to-r from-blue-600 to-blue-700 p-3 md:p-4 rounded-full hover:from-blue-700 hover:to-blue-800 transform hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl group"
                >
                  <FaFacebook className="text-lg md:text-xl text-white group-hover:scale-110 transition-transform" />
                </a>
                <a
                  href="#"
                  className="bg-gradient-to-r from-sky-400 to-sky-600 p-3 md:p-4 rounded-full hover:from-sky-500 hover:to-sky-700 transform hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl group"
                >
                  <FaTwitter className="text-lg md:text-xl text-white group-hover:scale-110 transition-transform" />
                </a>
                <a
                  href="#"
                  className="bg-gradient-to-r from-blue-700 to-blue-900 p-3 md:p-4 rounded-full hover:from-blue-800 hover:to-blue-950 transform hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl group"
                >
                  <FaLinkedin className="text-lg md:text-xl text-white group-hover:scale-110 transition-transform" />
                </a>
                <a
                  href="#"
                  className="bg-gradient-to-r from-gray-600 to-gray-800 p-3 md:p-4 rounded-full hover:from-gray-700 hover:to-gray-900 transform hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl group"
                >
                  <FaEnvelope className="text-lg md:text-xl text-white group-hover:scale-110 transition-transform" />
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <button
                    onClick={() => scrollToSection("features")}
                    className="text-gray-300 hover:text-white transition-colors cursor-pointer text-sm md:text-base"
                  >
                    Features
                  </button>
                </li>
            ...
            <div id="contact">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <FaEnvelope className="mr-3 text-blue-400 mt-1 flex-shrink-0 text-sm md:text-base" />
                  <span className="text-gray-300 text-xs md:text-sm break-all">
                    hello@facetrack.com
                  </span>
                </li>
                <li className="flex items-start">
                  <FaPhone className="mr-3 text-blue-400 mt-1 flex-shrink-0 text-sm md:text-base" />
                  <span className="text-gray-300 text-xs md:text-sm">
                    +1 (555) 123-4567
                  </span>
                </li>
                <li className="flex items-start">
                  <FaMapMarkerAlt className="mr-3 text-blue-400 mt-1 flex-shrink-0 text-sm md:text-base" />
          ...
          <div className="border-t border-gray-800 mt-8 md:mt-12 pt-6 md:pt-8 text-center">
            <p className="text-gray-300 text-xs md:text-sm px-4">
              © 2024 FaceTrack. All rights reserved. Made with ❤️ for modern
              organizations.
            </p>
          </div>
        </div>
          ...
          <div className="relative max-w-4xl w-full mx-4 bg-white rounded-2xl overflow-hidden shadow-2xl animate-scale-in">
            ...
            <div className="relative pb-[56.25%] h-0">
              ...
              <div className="absolute top-0 left-0 w-full h-full rounded-lg">
                <ReactPlayer
                  src="https://www.youtube.com/watch?v=saf17d-naJE"
                  width="100%"
                  height="100%"
                  controls={true}
                  playing={false}
