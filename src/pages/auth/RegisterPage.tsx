      ...
      <div className="relative z-10 text-center py-8 md:py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-none">
          ...
          <div className="inline-flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
            ...
            <span className="text-white font-medium text-sm md:text-base">Choose Your Organization Role</span>
          </div>
        </div>
      </div>
              ...
              <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl p-6 md:p-8 lg:p-10 shadow-2xl border border-white/20 hover:bg-white transition-all duration-500 w-full h-full flex flex-col">
                ...
                <div className="space-y-3 md:space-y-4 mb-6 md:mb-8 flex-grow">
                  {[
                    ...
                    <div key={index} className="flex items-center space-x-3 md:space-x-4 p-3 md:p-4 rounded-xl bg-indigo-50 border border-indigo-100 group-hover:bg-indigo-100 transition-colors duration-300">
              ...
              <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl p-6 md:p-8 lg:p-10 shadow-2xl border border-white/20 hover:bg-white transition-all duration-500 w-full h-full flex flex-col">
                ...
                <div className="space-y-3 md:space-y-4 mb-6 md:mb-8 flex-grow">
                  {[
                    ...
                    <div key={index} className="flex items-center space-x-3 md:space-x-4 p-3 md:p-4 rounded-xl bg-blue-50 border border-blue-100 group-hover:bg-blue-100 transition-colors duration-300">
                      <span className="text-xl md:text-2xl flex-shrink-0">{feature.icon}</span>
                      <span className="text-gray-700 font-medium text-sm md:text-base">{feature.text}</span>
                    </div>
                  ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 md:p-8 border border-white/20 w-full">
              <div className="flex items-center mb-4 md:mb-6">
                ...
                <h5 className="text-xl md:text-2xl font-bold text-white">For Administrators</h5>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 md:p-8 border border-white/20 w-full">
              <div className="flex items-center mb-4 md:mb-6">
                ...
                <h5 className="text-xl md:text-2xl font-bold text-white">For Team Members</h5>
              </div>
